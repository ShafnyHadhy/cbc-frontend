            ...
            <div className="w-[370px] lg:w-[600px] flex flex-col gap-4">
                                ...
                                <div className="w-full lg:w-[180px] lg:h-full flex items-center justify-center flex-row lg:flex-col">
                                    {
                                        ...
                                        <span className="text-secondary lg:w-full text-lg text-center lg:text-right pr-[10px] line-through mt-1 lg:mt-[20px]">LKR {item.labelledPrice.toFixed(2)}</span>
                                    }
                                    <span className="font-semibold text-accent lg:w-full text-2xl text-center lg:text-right pr-[10px] lg:mt-[5px]">LKR {item.price.toFixed(2)}</span>
                                </div>
                            </div>
                        )
                    })
                ...
                <div className="w-full lg:w-full h-[120px] bg-white flex flex-col-reverse lg:flex-row justify-end items-center relative">
                    ...
                    <div className="h-[50px]">
                        <span className="font-semibold text-accent w-full text-center lg:text-right text-2xl lg:pr-[10px] mt-[5px]">Total: LKR {getTotal().toFixed(2)}</span>
                    </div>
                </div>
            </div>
        </div>
